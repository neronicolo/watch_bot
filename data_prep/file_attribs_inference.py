...
# save csv to
csv_file_path = Path.home()/'programming/data/chrono24/file_attribs_inference.csv'
# directory path where images are stored
imgs_dir_path = Path.home()/'programming/data/chrono24/'
